...
class TrainOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--save_interval', type=int, default=5000, help='Frequency of evaluateing and saving models (by iteration)')
        ...
        self.parser.add_argument('--num_train_steps', type=int, default=60_000, help='Number of training iterations')
    ...
    def parse(self,accelerator):
        ...
        if self.opt.is_continue:
            ...
            get_opt(self.opt.opt_path,accelerator.device)
